...
res.render = function(view, opts, fn, parent, sub){
  ...
  try {
	/* 
	  Modified by windinsky , Added flash feature .
	  orignal code: return this._render(view, opts, fn, parent, sub);
	*/
	if (opts) {
	    if (this.req.session && this.req.session.flash) {
	      opts.flash = this.req.session.flash;
	    }else{
	      opts.flash = '';
	    }
	};
	var c = this._render(view, opts, fn, parent, sub);
	if (this.req.session) {
